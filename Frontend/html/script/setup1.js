...
let btn_up, btn_down, btn_top, btn_low, btn_set_vals;
...
const listenToUI = function () {
    ...
    btn_down.addEventListener('touchend', stop_moving);
    ...
    btn_up.addEventListener('touchend', stop_moving);
    ...
    btn_top.addEventListener('touchend', function () {
        socket.emit('F2B_set_end', {
            'ip': takel_ip,
            'start': false
        })
    ...
    btn_low.addEventListener('touchend', function () {
        socket.emit('F2B_set_end', {
            'ip': takel_ip,
            'end': false
        })
